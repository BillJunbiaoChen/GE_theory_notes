...
\subsection{Bid--Ask Spread (Transaction Costs)}
...
\subsection{Exogenous Borrowing Limits}
...
\subsection{Default (Limited Enforcement)}
...
\subsection{Collateral (Secured Borrowing)}
