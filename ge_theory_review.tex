...
I sincerely thank Alberto Bisin and Carlo Andreatta.}
}
\date{\today}
...
\input{entries/takeaways.tex}



% Chap 2
\input{entries/abstract_exchange_economies.tex}
\input{entries/consumption_externalities.tex}
\input{entries/abstract_production_economies.tex}

% Chap 3
\input{entries/financial_market_economies.tex}

\input{entries/sequential_trading_economies.tex}
% Chap 4
\input{entries/incomplete_markets.tex}

% Chap 5
\input{entries/sequential_production_economies.tex}

% Chap 6
\input{entries/assignment_and_search.tex}

% Chap 7
\input{entries/moral_hazard.tex}

\input{entries/infinite_horizon.tex}
\input{entries/math_preliminaries.tex}
% Questions
\input{entries/questions.tex}
